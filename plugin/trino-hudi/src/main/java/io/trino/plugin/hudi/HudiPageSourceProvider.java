...
import io.trino.plugin.hudi.page.HudiPageSourceBuilder;
import io.trino.plugin.hudi.page.HudiPageSourceBuilderFactory;
import io.trino.plugin.hudi.page.HudiParquetPageSourceBuilder;
        ...
        implements ConnectorPageSourceProvider
{
    ...
    private final Map<HoodieFileFormat, HudiPageSourceBuilder> pageSourceBuilderMap;
            ...
            HudiConfig hudiConfig)
    {
        ...
        this.context.put(
                HudiParquetPageSourceBuilder.CONTEXT_KEY_PARQUET_READER_OPTIONS,
            ...
            DynamicFilter dynamicFilter)
    {
        ...
        ConnectorPageSource dataPageSource = getHudiPageSourceBuilder(hudiFileFormat).createPageSource(
