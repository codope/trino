        ...
        implements SessionPropertiesProvider
{
    ...
    private static final String USE_METASTORE_FOR_PARTITIONS = "use_metastore_for_partitions";
    ...
    public HudiSessionProperties(HudiConfig hudiConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(
                        ...
                        false),
                booleanProperty(
                        USE_METASTORE_FOR_PARTITIONS,
                        "If disabled, then the partition info is fetched using Hudi's partition extractor and relative partition path.",
                        hudiConfig.getUseMetastoreForPartitions(),
                        false),
                booleanProperty(
    ...
    public static boolean shouldUseMetastoreForPartitions(ConnectorSession session)
    {
        return session.getProperty(USE_METASTORE_FOR_PARTITIONS, Boolean.class);
    }
