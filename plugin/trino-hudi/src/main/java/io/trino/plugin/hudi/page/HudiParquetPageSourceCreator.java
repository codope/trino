        ...
        extends HudiPageSourceCreator
{
            ...
            HudiSplit hudiSplit)
    {
        ...
        boolean useParquetColumnNames = shouldUseParquetColumnNames(session);
        ...
        try {
            ...
            ParquetMetadata parquetMetadata = hdfsEnvironment.doAs(session.getIdentity(), () -> readFooter(parquetDataSource));
