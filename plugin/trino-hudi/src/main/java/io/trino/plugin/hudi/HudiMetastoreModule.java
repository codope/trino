...
public class HudiMetastoreModule
        extends AbstractConfigurationAwareModule
{
    private final Optional<HiveMetastore> metastore;

    public HudiMetastoreModule(Optional<HiveMetastore> metastore)
    {
    ...
    public static class MetastoreValidator
    {
        ...
        public MetastoreValidator(HiveMetastore metastore)
        {
            if (metastore instanceof CachingHiveMetastore) {
                throw new RuntimeException("Hive metastore caching must not be enabled for Hudi");
            }
        }
    }
