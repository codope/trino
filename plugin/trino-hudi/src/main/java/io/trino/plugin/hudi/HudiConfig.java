...
public class HudiConfig
{
    ...
    private boolean useMetastoreForPartitions = true;
    ...
    @Config("hudi.use-metastore-for-partitions")
    @ConfigDescription("By default, partition info is fetched from the metastore. " +
            "When this config is disabled, then the partition info is fetched using Hudi's partition extractor and relative partition path.")
    public HudiConfig setUseMetastoreForPartitions(boolean useMetastoreForPartitions)
    {
        this.useMetastoreForPartitions = useMetastoreForPartitions;
        return this;
    }

    public boolean getUseMetastoreForPartitions()
    {
    ...
    @ConfigDescription("Number of threads to use for split generation.")
