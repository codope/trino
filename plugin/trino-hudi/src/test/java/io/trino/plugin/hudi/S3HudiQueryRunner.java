...
import static io.trino.plugin.hudi.HudiQueryRunner.HUDI_TESTS;
...
public final class S3HudiQueryRunner
{
            ...
            throws Exception
    {
        ...
        Configuration conf = hdfsEnvironment.getConfiguration(CONTEXT, new Path(basePath));
        ...
        dataLoader.initializeTables(queryRunner, metastore, HUDI_TESTS, basePath, conf);
        return queryRunner;
    }
