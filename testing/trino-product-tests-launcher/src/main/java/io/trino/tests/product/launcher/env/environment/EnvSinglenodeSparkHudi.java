...
@TestsEnvironment
public class EnvSinglenodeSparkHudi
        extends EnvironmentProvider
{
    ...
    @Inject
    public EnvSinglenodeSparkHudi(Standard standard, Hadoop hadoop, DockerFiles dockerFiles, PortBinder portBinder, String hadoopImagesVersion)
    {
        super(ImmutableList.of(standard, hadoop));
        this.dockerFiles = dockerFiles;
        this.portBinder = portBinder;
        this.hadoopImagesVersion = hadoopImagesVersion;
    }
    ...
    public void extendEnvironment(Environment.Builder builder)
    {
        ...
        builder.configureContainer(HADOOP, container -> container.setDockerImageName(dockerImageName));

        builder.addConnector(
                "hudi",
                forHostPath(dockerFiles.getDockerFilesHostPath("conf/environment/singlenode-spark-hudi/hudi.properties")),
                CONTAINER_PRESTO_ETC + "/catalog/hudi.properties");
    ...
    {
        DockerContainer container = new DockerContainer("ghcr.io/trinodb/testing/spark3-hudi:" + hadoopImagesVersion, "spark")
                .withEnv("HADOOP_USER_NAME", "hive")
                .withCopyFileToContainer(
                        forHostPath(dockerFiles.getDockerFilesHostPath("conf/environment/singlenode-spark-hudi/spark-defaults.conf")),
